...
w2 = Label(root, justify=LEFT, text="            A Project by Sabari and Hari", fg="white", bg="blue")
...
ranfLb = Label(root, text="     Prediction 3         ", fg="white", bg="red")
...
S6En.grid(row=12, column=0)

S7En = OptionMenu(root, Symptom7,*OPTIONS)
S7En.grid(row=13, column=0)

dst = Button(root, text="   Go   ", command=DecisionTree,bg="green",fg="yellow")
dst.grid(row=16, column=1,padx=0)

rnf = Button(root, text="   Go   ", command=randomforest,bg="green",fg="yellow")
rnf.grid(row=18, column=1,padx=0)

lr  = Button(root, text="   Go   ", command=NaiveBayes,bg="green",fg="yellow")
lr.grid(row=20, column=1,padx=0)

#textfileds
t1 = Text(root, height=1, width=40,bg="orange",fg="black")
t1.grid(row=16, column=0, padx=3)

t2 = Text(root, height=1, width=40,bg="orange",fg="black")
t2.grid(row=18, column=0 , padx=3)

t3 = Text(root, height=1, width=40,bg="orange",fg="black")
t3.grid(row=20, column=0 , padx=3)
